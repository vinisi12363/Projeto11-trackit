        ...
        <TodayContainer>
            ...
            <TodayMessageArea>
                ...
                <p>{listHabits.filter((p=>p.done===true)) ? "" : "Nenhum hábito concluído ainda"}</p>
                    ...
                    {!loadingHabit &&
                    <HabitsDayContainer ata-test="today-habit-container" >
                                <>
                                    { 
                                    listHabits.map((h=><HabitDayLabel>{
                                                <>
                                                    ...
                                                    <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <rect  data-test="today-habit-check-btn" x="0.5" y="0.5" width="68" height="68" rx="4.5" onClick={()=>{h.done? unMarkHabit(h.id) : markHabit(h.id)}} fill={h.done? "#8fc549" : "#ebebeb" }stroke="#E7E7E7" />
